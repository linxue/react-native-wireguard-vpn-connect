Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/linxue/react-native-wireguard-vpn-connect.git" # 可留空
  s.license      = "MIT"
  s.author       = { "Author" => "author@example.com" } # 可留空
  s.platform     = :ios, "13.0" # 匹配 RN 0.84 最低 iOS 版本
  s.source       = { :git => "https://github.com/linxue/react-native-wireguard-vpn-connect.git", :tag => "#{s.version}" } # 可留空
